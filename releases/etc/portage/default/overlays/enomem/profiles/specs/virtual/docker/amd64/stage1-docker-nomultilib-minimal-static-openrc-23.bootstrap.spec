subarch: amd64
target: stage1
version_stamp: docker-nomultilib-minimal-static-openrc-20250121T185900Z
rel_type: 23.0-enomem
repos: /home/portage/storage/gentoo/catalyst/releases/portage/23-enomem/stage1/overlays/enomem
profile: enomem:virtual/docker/amd64/no-multilib/minimal/static/stage1
...
update_seed: yes
update_seed_command: --update --newuse --complete-graph y --with-bdeps y --ignore-world y app-shells/dash
#update_seed_command: --update --newuse --complete-graph y --with-bdeps y --buildpkg --usepkg --binpkg-respect-use y app-shells/dash
